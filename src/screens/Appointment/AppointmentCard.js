...
class AppointmentCard extends Component {
  state = { status: "", accordionActive: styles.accordionInactive, data: [], isPatientArrived: undefined};
    ...
    if (userType !== "user" && this.state.status === "completed") {
      return (<div>
        <div className="form-check">
          <input onChange={event => this.setState({ isPatientArrived: true })} className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" />
          <label className="form-check-label" htmlFor="exampleRadios1">
            Patient Arrived
      </label>
        </div>
        <div className="form-check">
          <input onChange={event => this.setState({ isPatientArrived: false})} className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2"/>
        ...
        <div className="container row">
          ...
          <div className="radioWrapper">
            ...
            {this.state.isPatientArrived &&
              ...
              {this.state.isPatientArrived !== undefined && !this.state.isPatientArrived && this.state.status==="completed" &&
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-1">
